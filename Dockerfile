...
RUN yum install -y net-tools telnet vim wget &> /dev/null
...
RUN yum remove -y java-1.8.0-openjdk-devel &> /dev/null
RUN yum install -y java-11-openjdk-devel &> /dev/null
